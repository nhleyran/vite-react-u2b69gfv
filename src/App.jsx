  ...
  const JudgeIllustration = ({ size = 'w-32 h-32' }) => (
    <div className={`${size} relative flex items-center justify-center`}>
      <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-2xl">
        {/* Gavel */}
        <g transform="translate(130, 20) rotate(25)">
          <rect
            x="0"
            y="0"
            width="40"
            ...
            strokeWidth="1.5"
          />
          <rect x="15" y="28" width="10" height="50" fill="#5a4530" />
          <ellipse cx="20" cy="80" rx="10" ry="3" fill="#3a2a1c" />
        </g>
        {/* Wig */}
        <ellipse
          cx="100"
        ...
        />
        {/* Face */}
        <ellipse cx="100" cy="100" rx="28" ry="32" fill="#f4c8a8" />
        {/* Angry eyebrows */}
        <path
          d="M 80 90 L 95 95"
          stroke="#333"
        ...
        />
        {/* Eyes */}
        <circle cx="88" cy="100" r="2.5" fill="#1a1a1a" />
        <circle cx="112" cy="100" r="2.5" fill="#1a1a1a" />
        {/* Mouth - yelling */}
        <ellipse cx="100" cy="120" rx="10" ry="8" fill="#4a1515" />
        <ellipse cx="100" cy="121" rx="7" ry="5" fill="#8b2020" />
        {/* Collar */}
        <path
          d="M 75 140 L 100 155 L 125 140 L 130 170 L 70 170 Z"
          fill="#fff"
        />
        <rect x="85" y="155" width="30" height="30" fill="#fff" />
      </svg>
    </div>
  );
